...
for x in seg_point:
    ...
    segment.export("save_audio_mp3/{:0>2d}_{:0>6d}_{:0>6d}_".format(i,beg_point+350,end_point+350)+".mp3",format="mp3")
    beg_point=end_point
    i=i+1
segment=song[end_point:]
segment.export("save_audio_mp3/{:0>2d}_{:0>6d}_{:0>6d}_".format(i,beg_point+350,len(segment))+".mp3",format="mp3")
